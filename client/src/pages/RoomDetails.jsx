...
const RoomDetails = () => {
    ...
    //onsubmothandler function to check availabilty & book the user
    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Excepturi nulla architecto deserunt voluptas, incidunt, a est ratione necessitatibus labore commodi dolorum amet aliquam inventore doloremque. Laboriosam asperiores sed atque qui!
                </p>
            </div>
